...
export const EventsAdmin = () => (
  <CrudPage title="Events" description="Manage upcoming and past events." endpoint="events"
    ...
    fields={[
      ...
      { key: "event_format", label: "Format", type: "select", options: ["in_person", "online", "hybrid"], default: "in_person", hint: "in_person · online (Zoom/YouTube) · hybrid (both)" },
      { key: "date", label: "Date (display)", type: "text", required: true, placeholder: "May 17, 2026", hint: "Free-text shown in cards. Use the structured fields below for accurate sorting." },
      { key: "time", label: "Time", type: "text", placeholder: "5:00 PM – 9:00 PM" },
      { key: "start_date", label: "Start (date & time)", type: "datetime", hint: "Used for sorting and the online URL countdown" },
      { key: "end_date", label: "End (date & time)", type: "datetime", hint: "Set this to a later date for multi-day events" },
      { key: "venue", label: "Venue", type: "text", hint: "Required for in-person & hybrid events" },
      { key: "online_url", label: "Online Link (Zoom/YouTube/Meet)", type: "text", placeholder: "https://zoom.us/j/...", hint: "Required for online & hybrid events" },
      ...
      { key: "ticket_types", label: "Ticket Types", type: "ticket-types", hint: "Each tier supports regular / member / early-bird prices. Buyers automatically get the cheapest applicable price at checkout." },
      { key: "promo_codes", label: "Promo Codes", type: "promo-codes", hint: "Optional discount codes — buyers enter at checkout. Percent (e.g. 20 = 20% off) or fixed amount (e.g. $10 off)." },
